...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260306230027_AddTableProjentRuleAndProjectPayment")]
    partial class AddTableProjentRuleAndProjectPayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Features.Payrolls.Aggregates.Payments.DeductionPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("DeductionRuleId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("deduction_payments", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Features.Payrolls.Aggregates.Payments.ProjectPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Features.Payrolls.Entities.ActivityProductivityWeight", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("RedmineActivityId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RedmineActivityId")
                        .IsUnique();

                    b.ToTable("activity_productivity_weights", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Features.Payrolls.Rules.ProductivityRule", b =>
                {
                    ...
                    b.Property<decimal>("FullBonusTarget")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)");
                    ...
                    b.Property<decimal?>("MaxBonusCap")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Domain.Features.Payrolls.Rules.ProjectRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Features.Projects.Aggregates.MilestoneParticipation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProjectMilestoneId", "EmployeeId")
                        .IsUnique();

                    b.ToTable("milestone_participations", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Features.Projects.Aggregates.MilestoneParticipation", b =>
                {
                    b.HasOne("Domain.Features.Projects.Aggregates.ProjectMilestone", "ProjectMilestone")
            ...
            modelBuilder.Entity("Domain.Features.Payrolls.Aggregates.Payroll", b =>
                {
                    ...
                    b.Navigation("DeductionPayments");
